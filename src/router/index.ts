  ...
  },
  {
    ...
    children: [
...

      {
        path: 'self/profile',
        name: 'UserProfile',
        component: () => import('@/user/pages/self/Profile.vue'),
        meta: { title: '个人信息', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
        path: 'self/apply',
        name: 'UserApply',
        component: () => import('@/user/pages/self/Apply.vue'),
        meta: { title: '我的申请', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
        path: 'self/attendance',
        name: 'UserAttendance',
        component: () => import('@/user/pages/self/Attendance.vue'),
        meta: { title: '我的考勤', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
        path: 'self/performance',
        name: 'UserPerformance',
        component: () => import('@/user/pages/self/Performance.vue'),
        meta: { title: '我的绩效', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
        path: 'self/salary',
        name: 'UserSalary',
        component: () => import('@/user/pages/self/Salary.vue'),
        meta: { title: '我的薪酬', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
        path: 'self/training',
        name: 'UserTraining',
        component: () => import('@/user/pages/self/Training.vue'),
        meta: { title: '我的培训', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
        path: 'self/survey',
        name: 'UserSurvey',
        component: () => import('@/user/pages/self/Survey.vue'),
        meta: { title: '员工问卷', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
        path: 'self/notice',
        name: 'UserNotice',
        component: () => import('@/user/pages/self/Notice.vue'),
        meta: { title: '系统公告', requiresAuth: true, roles: ['user', 'manager'] },
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'WorkflowConfig',
        component: () => import('@/admin/pages/workflow/ConfigList.vue'),
        meta: { title: '流程配置', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'workflow/instance',
        name: 'WorkflowInstance',
        component: () => import('@/admin/pages/workflow/InstanceList.vue'),
        meta: { title: '流程实例', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
      ...
      },
      {
        ...
        name: 'OvertimeList',
        component: () => import('@/admin/pages/attendance/overtime/OvertimeList.vue'),
        meta: { title: '加班申请', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'attendance/quota',
        name: 'QuotaList',
        component: () => import('@/admin/pages/attendance/quota/QuotaList.vue'),
        meta: { title: '假期额度', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'attendance/report',
        name: 'ReportList',
        component: () => import('@/admin/pages/attendance/report/ReportList.vue'),
        meta: { title: '考勤报表', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'performance/plan',
        name: 'PlanList',
        component: () => import('@/admin/pages/performance/plan/PlanList.vue'),
        meta: { title: '绩效方案', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'performance/evaluation',
        name: 'EvaluationList',
        component: () => import('@/admin/pages/performance/evaluation/EvaluationList.vue'),
        meta: { title: '绩效评估', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'performance/result',
        name: 'ResultList',
        component: () => import('@/admin/pages/performance/result/ResultList.vue'),
        meta: { title: '绩效结果', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'performance/goal',
        name: 'GoalList',
        component: () => import('@/admin/pages/performance/goal/GoalList.vue'),
        meta: { title: '绩效目标', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'performance/track',
        name: 'TrackList',
        component: () => import('@/admin/pages/performance/track/TrackList.vue'),
        meta: { title: '绩效跟踪', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'performance/improve',
        name: 'ImproveList',
        component: () => import('@/admin/pages/performance/improve/ImproveList.vue'),
        meta: { title: '绩效改进计划', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'org/dept',
        name: 'DeptList',
      ...
      },
      {
        path: 'salary/grade',
        name: 'GradeList',
        component: () => import('@/admin/pages/salary/grade/GradeList.vue'),
        meta: { title: '薪资等级', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'salary/config',
        name: 'ConfigList',
        component: () => import('@/admin/pages/salary/config/ConfigList.vue'),
        meta: { title: '薪资档案', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'salary/calculate',
        name: 'CalculateList',
        component: () => import('@/admin/pages/salary/calculate/CalculateList.vue'),
        meta: { title: '薪酬核算', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'salary/record',
        name: 'RecordList',
        component: () => import('@/admin/pages/salary/record/RecordList.vue'),
        meta: { title: '月度薪酬', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'salary/adjust',
        name: 'AdjustList',
        component: () => import('@/admin/pages/salary/adjust/AdjustList.vue'),
        meta: { title: '薪酬调整', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'salary/social',
        name: 'SocialList',
        component: () => import('@/admin/pages/salary/social/SocialList.vue'),
        meta: { title: '社保公积金', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'salary/welfare',
        name: 'WelfareManagement',
        component: () => import('@/admin/pages/salary/Welfare.vue'),
        meta: { title: '福利管理', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'training/need',
        name: 'NeedList',
        component: () => import('@/admin/pages/training/need/NeedList.vue'),
        meta: { title: '培训需求', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'training/activity',
        name: 'ActivityList',
        component: () => import('@/admin/pages/training/activity/ActivityList.vue'),
        meta: { title: '培训活动', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'training/effect',
        name: 'EffectList',
        component: () => import('@/admin/pages/training/effect/EffectList.vue'),
        meta: { title: '效果评估', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'training/learning',
        name: 'LearningList',
        component: () => import('@/admin/pages/training/learning/LearningList.vue'),
        meta: { title: '在线学习', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'training/checkin',
        name: 'CheckinList',
        component: () => import('@/admin/pages/training/checkin/CheckinList.vue'),
        meta: { title: '培训签到', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
      {
        path: 'training/course',
        name: 'CourseList',
        component: () => import('@/admin/pages/training/course/CourseList.vue'),
        meta: { title: '课程管理', requiresAuth: true, roles: ['admin', 'superadmin'] },
      },
